...
import {
  ...
  ArrowRight, CornerDownLeft, type LucideIcon,
} from "lucide-react";

type Item = {
  id: string;
  label: string;
  hint?: string;          // descripcion corta
  href?: string;
  action?: () => void;
  icon: LucideIcon;
  color: string;          // color del icono (visual cue)
  group: string;
  keywords?: string;
  shortcut?: string;      // hint del shortcut directo si aplica
};
...
export function CommandPalette({ onShowShortcuts }: { onShowShortcuts: () => void }) {
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      // Boton externo dispara evento custom
  ...
  const items: Item[] = [
    // Navegacion
    { id: "nav-dashboard",     label: "Dashboard",      hint: "Vista general de hoy",          icon: LayoutGrid,    color: "#3b82f6", href: "/dashboard",     group: "Navegar a", keywords: "inicio home",                    shortcut: "G D" },
    ...
    { id: "nav-dispositivos",  label: "Estaciones",     hint: "Equipos físicos vinculados",    icon: Monitor,       color: "#06b6d4", href: "/dispositivos",  group: "Navegar a", keywords: "dispositivos kiosko hardware",   shortcut: "G S" },
    ...
    { id: "nav-reportes",      label: "Reportes",       hint: "Estadísticas y análisis",       icon: BarChart3,     color: "#ec4899", href: "/reportes",      group: "Navegar a", keywords: "estadisticas analytics graficas",shortcut: "G R" },
    { id: "nav-configuracion", label: "Configuración",  hint: "Ajustes de la empresa",         icon: Settings,      color: "#6b7280", href: "/configuracion", group: "Navegar a", keywords: "settings ajustes preferencias",  shortcut: "G C" },
    ...
    { id: "new-dispositivo",  label: "Registrar estación", hint: "Vincula un equipo físico",    icon: Plus, color: "#06b6d4", href: "/dispositivos?new=1",   group: "Crear nuevo", keywords: "agregar dispositivo equipo" },
      ...
      <div onClick={(e) => e.stopPropagation()} style={modalStyle}>
        <Command label="Comandos" loop>
          ...
          <div style={searchBarStyle}>
            ...
            <Command.Input
              placeholder="¿Qué quieres hacer? Escribe lo que buscas..."
              autoFocus
