...
def main():
    ...
    if not employee_data:
        print(
            "⚠️ No hay datos de empleados. El sistema funcionará pero sin información adicional."
        )
    ...
    image_files = [
        f for f in photos_dir.iterdir() if f.suffix.lower() in image_extensions
    ]
    ...
    data = {"encodings": encodings, "employee_ids": employee_ids}
